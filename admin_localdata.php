...
<div id="button">
		...
		<li><a href="admin.php"><i class="fa fa-home"></i>&nbsp; Dashboard</a></li>
			...
			<li><a href="admin_localdata.php"><i class="fa fa-database"></i>&nbsp; Employee</a></li>
			<li><a href="admin_globaldata.php"><i class="fa fa-server"></i>&nbsp; Stock Data</a></li>
...
<div id="tabbed_box" class="tabbed_box">  
    <h4>To find pharmacist from the company from the local database</h4> 
<hr/>	
...
<option value="Newark">NEKEMT</option>
<option value="Ladora">BISHOFTU</option>
</select>
...
?>
	   ...
	   if($selected_val=="All")
	   				$result = mysqli_query($con ,"SELECT * FROM pharmacist")or die(mysqli_error());	
	   if($selected_val=="addis abeba")
				   $result = mysqli_query($con ,"SELECT * FROM pharmacist WHERE postal_address='addis abeba' ")or die(mysqli_error());
		if($selected_val=="Adama")
				   $result = mysqli_query($con ,"SELECT * FROM pharmacist WHERE postal_address='adama' ")or die(mysqli_error());

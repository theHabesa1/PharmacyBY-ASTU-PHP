...
<div id="tabbed_box" class="tabbed_box">  
    <h4>To find minimum/maximum cost of medicine from different cities Regiterd from Stock database</h4> 
<hr/>	
...
<?php echo $message;
		...
		*/
		...
		$result = mysqli_query($con,"SELECT * FROM stock_np UNION ALL SELECT * FROM stock_ca UNION ALL SELECT * FROM stock_dr  order by stock_id")  or die(mysql_error());
